...
t_uint32 oscilloscope_config_v1::g_get_version() {
    return 1;
}

oscilloscope_config_v1::oscilloscope_config_v1() {
    reset();
}

void oscilloscope_config_v1::reset() {
...
void oscilloscope_config_v1::parse(ui_element_config_parser & parser) {
    reset();
...
void oscilloscope_config_v1::build(ui_element_config_builder & builder) {
